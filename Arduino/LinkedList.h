...
class LinkedList
{
  ...
  public:
    LinkedList();
    LinkedList(const T list[], int size);
...
template <class T>
LinkedList<T>::LinkedList(const T list[], int size)
{
  length = 0;
  head = nullptr;
  tail = nullptr;
